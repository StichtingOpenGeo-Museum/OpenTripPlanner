 ...
 */
public class DutchWayPropertySetSource implements WayPropertySetSource {
    ...
    public WayPropertySet getWayPropertySet() {
        ...
        createNotes(props, "surface=unpaved", "Onverhard oppervlak");
        createNotes(props, "surface=compacted", "Onverhard oppervlak");
        createNotes(props, "surface=ground", "Onverhard oppervlak");
        createNotes(props, "surface=dirt", "Onverhard oppervlak");
        createNotes(props, "surface=earth", "Onverhard oppervlak");
        createNotes(props, "surface=grass", "Onverhard oppervlak");
        createNotes(props, "surface=mud", "Onverhard oppervlak");

        /* and some names */
        // Basics
        createNames(props, "highway=cycleway", "fietspad");
        createNames(props, "cycleway=track", "fietspad");
        createNames(props, "highway=pedestrian", "pad");
        createNames(props, "highway=pedestrian;area=yes", "open ruimte");
        createNames(props, "highway=path", "pad");
        createNames(props, "highway=footway", "pad");
        createNames(props, "highway=bridleway", "ruiterpad");
        createNames(props, "highway=footway;bicycle=no", "voetpad");

        // Platforms
        createNames(props, "otp:route_ref=*", "Route {otp:route_ref}");
        createNames(props, "highway=platform;ref=*", "Perron {ref}");
        createNames(props, "railway=platform;ref=*", "Perron {ref}");
        createNames(props, "railway=platform;highway=footway;footway=sidewalk", "perron");
        createNames(props, "railway=platform;highway=path;path=sidewalk", "perron");
        createNames(props, "railway=platform;highway=pedestrian", "perron");
        createNames(props, "railway=platform;highway=path", "perron");
        createNames(props, "railway=platform;highway=footway", "perron");
        ...
        createNames(props, "highway=path;bridge=*", "voetgangersbrug");
        createNames(props, "highway=footway;bridge=*", "voetgangersbrug");

        createNames(props, "highway=pedestrian;tunnel=*", "onderdoorgang");
        createNames(props, "highway=path;tunnel=*", "onderdoorgang");
        createNames(props, "highway=footway;tunnel=*", "onderdoorgang");

        // Basic Mappings
        createNames(props, "highway=motorway", "snelweg");
        createNames(props, "highway=motorway_link", "afslag");
        createNames(props, "highway=trunk", "autoweg");
        createNames(props, "highway=trunk_link", "afslag");

        createNames(props, "highway=primary", "weg");
        createNames(props, "highway=primary_link", "weg");
        createNames(props, "highway=secondary", "weg");
        createNames(props, "highway=secondary_link", "weg");
        createNames(props, "highway=tertiary", "weg");
        createNames(props, "highway=tertiary_link", "weg");
        createNames(props, "highway=unclassified", "weg");
        createNames(props, "highway=residential", "weg");
        createNames(props, "highway=living_street", "road");
        createNames(props, "highway=road", "weg");
        createNames(props, "highway=service", "ventweg");
        createNames(props, "highway=service;service=alley", "steeg");
        createNames(props, "highway=service;service=parking_aisle", "parkeerweg");
        createNames(props, "highway=byway", "weg");
        createNames(props, "highway=track", "bosweg");

        createNames(props, "highway=footway;footway=sidewalk", "trottoir");
        createNames(props, "highway=path;path=sidewalk", "trottoir");

        createNames(props, "highway=steps", "trap");
        createNames(props, "highway=steps;escalator=*", "roltrap");

        createNames(props, "amenity=bicycle_rental;name=*", "Fietsverhuur {name}");
        createNames(props, "amenity=bicycle_rental", "Fietsverhuur");
